...
function Customize() {
  ...
  const handleSave = () => {
    ...
    if (
      (settings.playerName === '' || settings.gameDir === '') &&
      n.playerName !== '' &&
      n.gameDir !== ''
    ) {
      setLocked(false);
      ...
      .then((gamePath) => {
        if (gamePath) {
          ...
          if (gamePath.endsWith('\\gta-vc.exe')) {
            handleInputChange(
              'gamedir',
              gamePath.slice(0, gamePath.length - 11)
            );
          }
          ...
          if (gamePath.endsWith('\\testapp.exe')) {
            handleInputChange(
              'gamedir',
              gamePath.slice(0, gamePath.length - 12)
            );
            isSteam = true;
          }
  ...
  const fieldsNotSet =
    settings.gameDir.length === 0 || settings.playerName.length === 0;
      ...
      <Content>
        <div className="cszWrapper">
          ...
          <div>
            ...
            <div className="cszField cszFieldMargin">
              ...
              <InputGroup className="cszIpt">
                ...
                <InputGroup.Button appearance="primary" onClick={selectGameDir}>
                  <OpenIcon />
                </InputGroup.Button>
              </InputGroup>
            </div>
          ...
          <div className="cszActionsRight">
            <Button appearance="primary" onClick={handleUnhide}>
              Unhide all servers
            </Button>
          </div>
        </div>
        ...
        {fieldsNotSet && (
          <div className="cszFooter">Game directory or Nickname not set!</div>
        )}
      </Content>
    </React.Fragment>
  );
