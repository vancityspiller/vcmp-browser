  ...
  return (
    <Content>
      <div className="abtWrapper">
        ...
        <span className="abtSubTitle">
          vcmp-browser v{version} <span>[tauri]</span>
        </span>
        ...
        <div className="abtInnerWrapper">
          <div className="abtSecHeader">Contact</div>
          ...
          <div
            className="abtPointer"
            onClick={() => openWebsite('https://github.com/vancityspiller')}
          >
            <Tag className="abtSecInfo" size="lg">
          ...
          <div className="abtSecHeader">Support</div>

          <div
            className="abtPointer"
            onClick={() => openWebsite('https://discord.com/invite/g8dK8DhYSg')}
          >
            <Tag className="abtSecInfo" size="lg">
              <img src={DiscordIcon} className="abtTagIcon" />
              <span className="discriminator">Join</span> OneVice{' '}
              <span className="discriminator">discord</span>
            </Tag>
          </div>
        </div>
      </div>
